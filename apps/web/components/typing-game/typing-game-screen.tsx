...
import { Keyboard, Languages, Timer } from 'lucide-react';
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-lg flex-col gap-4 px-4 py-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-base font-semibold leading-tight">Keypad</h1>
      ...
      {game.phase === 'setup' ? (
        <Card className="animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full" size="lg" onClick={game.start} disabled={game.words.length === 0}>
              Start test
            </Button>
          </div>
        </Card>
      ...
      {game.phase === 'running' ? (
        <div className="flex flex-col gap-4">
          ...
          />
          <div className="flex min-h-[9rem] flex-col items-center justify-center gap-6 rounded-2xl border border-line bg-surface-raised px-4 py-8">
            ...
            <input
              ...
              spellCheck={false}
              enterKeyHint="next"
              className="w-full max-w-xs rounded-xl border border-line bg-surface px-3 py-2 text-center font-mono text-lg outline-none focus:border-brand"
            />
          </div>
