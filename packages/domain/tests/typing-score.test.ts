...
describe('computeTypingResult', () => {
  it('counts correct and incorrect words and reports the elapsed time', () => {
    const result = computeTypingResult({
      ...
      durationSeconds: 60,
      attempts: [
        { word: 'alpha', typed: 'alpha', correct: true, submittedAt: '2026-01-01T00:00:01.000Z' },
        { word: 'bravo', typed: 'brawo', correct: false, submittedAt: '2026-01-01T00:00:03.000Z' },
      ],
      totalKeystrokes: 10,
      correctKeystrokes: 9,
      elapsedMs: 60_000,
